...
export default async function SchoolsPage({
  ...
  const [{ data: vendors }, { data: meetings }, { data: redFlags }, { data: questions }] = await Promise.all([
    ...
    svc.from('meetings')
      .select('id, vendor_id, title, scheduled_at, duration_minutes, comm_type, topics, key_points, questions_asked, athlete_takeaway, energy_level, who_initiated, notes, attendees, nps_score, nps_reason, parent_nps_score, parent_nps_reason, best_thing, concern')
      .eq('engagement_id', engagementId)
